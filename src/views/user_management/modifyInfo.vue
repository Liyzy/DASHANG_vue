<template>
    <div class="modify_info_container">
        <el-container class="modify_info_container">
            <!-- 头部导航栏 -->
            <el-header>
                <div>
                ...
                <div class="user_info_container">
                    <span><a href="https://www.baidu.com">我的邮件</a></span>
                    ...
                    <el-dropdown>
                        ...
                        <el-dropdown-menu slot="dropdown">
                            ...
                            <el-dropdown-item><i class="el-icon-right"></i>注销</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                </div>
            </el-header>
                ...
                <div>
                    <el-form ref="modifyFormRef" :model="modifyForm" :rules="modifyFormRules" label-width="90px"
                        ...
                        <el-form-item label="用户名:" prop="newUsername">
                            <el-input v-model="modifyForm.newUsername" prefix-icon="el-icon-user"
                                      autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="身份证号:" prop="IDNumber">
                            <el-input v-model="modifyForm.IDNumber" prefix-icon="el-icon-postcard"
                                      autocomplete="off"></el-input>
                        </el-form-item>
                        ...
                        <el-form-item class="login_btn_area">
                            ...
                            <el-button native-type="reset" round>重置</el-button>
                        </el-form-item>
                    </el-form>
                </div>
            </el-main>
